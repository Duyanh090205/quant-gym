 ...
 *
 * `example` is a pair, `{ ask, work }`, and the split is deliberate. Left as one
 * string these decayed into answer keys — "first to roll a 6: p = 1/6, so 6/11" —
 * which only make sense to a reader who already knows the puzzle. The question
 * has to be on the card in full before any working is shown.
 */
...
export const TIPS = [
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ask: "What are 48 × 5, 36 × 11 and 78 × 11?",
        work: "48 × 5 → 480 ÷ 2 = 240.   36 × 11 → 3 (3+6) 6 = 396.   78 × 11 → 7 (15) 8, carry the 1 → 858",
      },
    ...
    vi: {
      ...
      example: {
        ask: "48 × 5, 36 × 11 và 78 × 11 bằng bao nhiêu?",
        work: "48 × 5 → 480 ÷ 2 = 240.   36 × 11 → 3 (3+6) 6 = 396.   78 × 11 → 7 (15) 8, nhớ 1 → 858",
      },
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ask: "What are 37² and 48²?",
        work: "37² → slide 3 down: 34 × 40 = 1360, add 3² = 9 → 1369.   48² → slide 2 up: 46 × 50 = 2300, add 2² = 4 → 2304",
      },
    ...
    vi: {
      ...
      example: {
        ask: "37² và 48² bằng bao nhiêu?",
        work: "37² → trượt 3 xuống: 34 × 40 = 1360, cộng 3² = 9 → 1369.   48² → trượt 2 lên: 46 × 50 = 2300, cộng 2² = 4 → 2304",
      },
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ...
        work: "8 and 24 share a factor of 8. Cancel it and the line becomes 240 = 3 × ?, so the answer is 80",
      },
    ...
    vi: {
      ...
      example: {
        ...
        work: "8 và 24 cùng chia hết cho 8. Rút gọn thì dòng này thành 240 = 3 × ?, nên đáp án là 80",
      },
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ask: "What are 3/8 and 5/6 as percentages?",
        work: "3/8 = 1/4 + 1/8 = 25% + 12.5% = 37.5%.   5/6 = 100% − 1/6 = 100% − 16.7% = 83.3%",
      },
    ...
    vi: {
      ...
      example: {
        ask: "3/8 và 5/6 bằng bao nhiêu phần trăm?",
        work: "3/8 = 1/4 + 1/8 = 25% + 12,5% = 37,5%.   5/6 = 100% − 1/6 = 100% − 16,7% = 83,3%",
      },
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ask: "What is 18% of 50? And 4% of 75?",
        work: "18% of 50 is awkward, but 50% of 18 is 9.   4% of 75 is awkward, but 75% of 4 is 3",
      },
    ...
    vi: {
      ...
      example: {
        ask: "18% của 50 bằng bao nhiêu? Còn 4% của 75?",
        work: "18% của 50 thì khó, nhưng 50% của 18 là 9.   4% của 75 thì khó, nhưng 75% của 4 là 3",
      },
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ...
        work: "Pairs that work, counting the dice as different: (1,4) (2,3) (3,2) (4,1) → 4 out of 36 → 1/9. Not 1/11: the eleven totals are not equally likely",
      },
    ...
    vi: {
      ...
      example: {
        ...
        work: "Các cặp thoả mãn, coi hai xúc xắc là khác nhau: (1,4) (2,3) (3,2) (4,1) → 4 trên 36 → 1/9. Không phải 1/11: mười một tổng không đồng khả năng",
      },
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ...
        work: "Chance of no 6 at all: (5/6)³ = 125/216. Everything else is at least one → 1 − 125/216 = 91/216",
      },
    ...
    vi: {
      ...
      example: {
        ...
        work: "Xác suất không ra mặt 6 lần nào: (5/6)³ = 125/216. Mọi trường hợp còn lại là ít nhất một → 1 − 125/216 = 91/216",
      },
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ...
        work: "Each day multiplies the price by 1.1 or 0.9, averaging (1.1 + 0.9)/2 = 1. So 100 × 1 × 1 = 100. Up-then-down gives 99, but that is one path out of four, not the average",
      },
    ...
    vi: {
      ...
      example: {
        ...
        work: "Mỗi ngày nhân giá với 1,1 hoặc 0,9, trung bình là (1,1 + 0,9)/2 = 1. Nên 100 × 1 × 1 = 100. Lên rồi xuống ra 99, nhưng đó là một trong bốn đường đi, không phải trung bình",
      },
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ...
        work: "Families, oldest first: BB, BG, GB, GG. The clue rules out GG and leaves three, one of which is BB → 1/3. Told instead that the OLDER child is a boy, only BB and BG survive → 1/2",
      },
    ...
    vi: {
      ...
      example: {
        ...
        work: "Các gia đình, con lớn trước: BB, BG, GB, GG. Dữ kiện loại GG và còn ba, trong đó một là BB → 1/3. Nếu đề nói con LỚN là trai thì chỉ còn BB và BG → 1/2",
      },
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ...
        work: "Each coin's readiness to give heads: 1/4, 1/2, 3/4. The 3/4 coin's share is (3/4) ÷ (1/4 + 1/2 + 3/4) = (3/4) ÷ (3/2) = 1/2",
      },
    ...
    vi: {
      ...
      example: {
        ...
        work: "Mức sẵn sàng ra ngửa của từng đồng: 1/4, 1/2, 3/4. Phần của đồng 3/4 là (3/4) ÷ (1/4 + 1/2 + 3/4) = (3/4) ÷ (3/2) = 1/2",
      },
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ask: "How many rolls, on average, until a die has shown three 5s? And how many coin flips until you first see two heads in a row?",
        work: "A 5 arrives every 1 ÷ (1/6) = 6 rolls, and waits add, so 3 × 6 = 18. Two heads in a row takes 6 flips, because a tail wipes the run out; heads-then-tails takes only 4",
      },
    ...
    vi: {
      ...
      example: {
        ask: "Trung bình bao nhiêu lần tung để xúc xắc ra ba mặt 5? Và bao nhiêu lần tung xu để lần đầu thấy hai mặt ngửa liên tiếp?",
        work: "Một mặt 5 tới sau mỗi 1 ÷ (1/6) = 6 lần tung, và các lần chờ cộng được, nên 3 × 6 = 18. Hai ngửa liên tiếp mất 6 lần, vì một mặt sấp xoá sạch chuỗi; ngửa rồi sấp chỉ mất 4",
      },
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ...
        work: "Stay → 1/3. Switch → 2/3, so switch. Try it with 100 doors: he opens 98 goats, and switching wins 99 times in 100",
      },
    ...
    vi: {
      ...
      example: {
        ...
        work: "Giữ → 1/3. Đổi → 2/3, vậy nên đổi. Thử với 100 cửa: anh ta mở 98 cửa có dê, và đổi cửa thắng 99 lần trên 100",
      },
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ask: "You hold 3 coins and your opponent holds 2. Each round you flip a fair coin and the loser pays 1, until someone has none. What is the chance you end up with all five?",
        work: "Five coins on the table and three are yours → 3/5. Hold 1 against 9 instead and it drops to 1/10",
      },
    ...
    vi: {
      ...
      example: {
        ...
        work: "Năm đồng trên bàn, ba đồng là của bạn → 3/5. Nếu cầm 1 đấu 9 thì tụt còn 1/10",
      },
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ...
        work: "One turn succeeds with p = 1/6, so P = 1/(2 − 1/6) = 6/11 ≈ 0.545. If they flipped for heads instead, p = 1/2 and P = 2/3",
      },
    ...
    vi: {
      ...
      example: {
        ...
        work: "Một lượt thành công với p = 1/6, nên P = 1/(2 − 1/6) = 6/11 ≈ 0,545. Nếu đổi thành tung xu lấy mặt ngửa thì p = 1/2 và P = 2/3",
      },
  ...
  },
  {
    ...
    en: {
      ...
      example: {
        ask: "Five random numbers are drawn one after another. What is the chance they come out in decreasing order? And with three draws, what is the chance the second one is the biggest?",
        work: "Five values can arrive in 5! = 120 orders and one of them is decreasing → 1/120. With three draws, each is equally likely to be the biggest → 1/3",
      },
    ...
    vi: {
      ...
      example: {
        ask: "Năm số ngẫu nhiên được lấy ra lần lượt. Xác suất chúng ra theo thứ tự giảm dần? Và với ba lần lấy, xác suất số thứ hai là lớn nhất?",
        work: "Năm số có thể ra theo 5! = 120 thứ tự, trong đó một thứ tự là giảm dần → 1/120. Với ba lần lấy, mỗi số đều có cơ hội là lớn nhất như nhau → 1/3",
      },
