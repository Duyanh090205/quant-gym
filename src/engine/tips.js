...
export const TIPS = [
  ...
  },
  {
    ...
    skill: "prob.bayes",
    en: {
      title: "When the priors are equal, Bayes is just a share of the likelihoods",
      steps: [
        "Write each hypothesis's chance of producing what you saw.",
        "The answer is your hypothesis's number divided by the sum of all of them.",
        "Equal priors cancel top and bottom, so you never multiply by 1/3.",
      ],
      example: "Coins with P(H) = 1/4, 1/2, 3/4, one flip lands heads → P(it was the 3/4 coin) = (3/4) / (1/4 + 1/2 + 3/4) = 1/2",
      why: "It turns Bayes from a formula you half-remember into a division you can do out loud.",
    },
    vi: {
      title: "Khi các prior bằng nhau, Bayes chỉ là chia phần của likelihood",
      steps: [
        "Viết ra khả năng mỗi giả thuyết tạo ra thứ bạn vừa thấy.",
        "Đáp án là số của giả thuyết bạn hỏi chia cho tổng tất cả.",
        "Prior bằng nhau thì triệt tiêu trên dưới, nên không cần nhân 1/3.",
      ],
